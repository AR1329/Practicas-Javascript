...
function CalcularEdad()
{
    ...
    //Se declara otra variable para leer el valor de input ine 
    var ine = Number(document.getElementById("INE").value);
    //Se crea una variable para imprimir la información
    var ImprimirInformación = document.getElementById("ImprimirEdad");


    if(edad >=18 && ine==1){
        //InnerText lo que hace es mandar llamar al html e imprimir el resultado
        ImprimirInformación.innerText = "La persona es mayor de edad,tiene su ine y puede tomar";
    }else if(edad >=18 && ine==0){
        ImprimirInformación.innerText = "La persona es mayor de edad, pero como no tiene su ine no puede tomar";
    }else if(edad <18 && ine==0){
        ImprimirInformación.innerText = "La persona es menor de edad, pero no puede tener ine";
    }
